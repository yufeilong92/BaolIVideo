...
import com.xuechuan.myapplication.fragment.PolyvPlayerDanmuFragment;
import com.xuechuan.myapplication.fragment.PolyvPlayerTabFragment;
import com.xuechuan.myapplication.fragment.PolyvPlayerTopFragment;
import com.xuechuan.myapplication.fragment.PolyvPlayerViewPagerFragment;
import com.xuechuan.myapplication.player.PolyvPlayerLightView;
import com.xuechuan.myapplication.player.PolyvPlayerMediaController;
import com.xuechuan.myapplication.player.PolyvPlayerPreviewView;
import com.xuechuan.myapplication.player.PolyvPlayerProgressView;
import com.xuechuan.myapplication.player.PolyvPlayerVolumeView;
import com.xuechuan.myapplication.utils.PolyvErrorMessageUtils;
import com.xuechuan.myapplication.utils.PolyvScreenUtils;
...
//    private PolyvPlayerAuxiliaryView auxiliaryView = null;
    ...
    private void addFragment() {
        ...
        // 网校的在线视频才添加下面的控件
        if (!getIntent().getBooleanExtra(MainActivity.IS_VLMS_ONLINE, false)) {
            ft.commit();
            return;
        }
